...
class Routes {
  static Route toHomePassengerPage({ ServiceInCourseEntity serviceInCourse }) => MaterialPageRoute(builder: (context)=> HomeClientPage(serviceInCourse: serviceInCourse));
