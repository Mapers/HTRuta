...
class Routes {
  ...
  static Route toListInterprovincialRequestFullScreenDialog(String documentId, List<InterprovincialRequestEntity> requests) => MaterialPageRoute(builder: (context)=> ListRequestsFullScreenDialog(requests, documentId: documentId), fullscreenDialog: true);
}